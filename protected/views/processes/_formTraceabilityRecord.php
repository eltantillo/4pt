...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<?php echo $form->textArea($model,'traceability_recordcol',array('rows'=>6, 'cols'=>50, 'class'=>'form-control', 'placeholder'=>'')); ?>
		<?php echo $form->error($model,'traceability_recordcol'); ?>
	</div>

	<div class="form-group">
		<?php echo $form->labelEx($model,'traceability_recordcol1'); ?>
		<?php echo $form->textField($model,'traceability_recordcol1',array('size'=>45,'maxlength'=>45, 'class'=>'form-control', 'placeholder'=>'')); ?>
