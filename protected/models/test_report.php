...
class test_report extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'test_case' => Language::$testCase,
			'tester_id' => Language::$tester,
			'defect_level' => Language::$defectLevel,
			'affected_functions' => Language::$affectedFunctions,
			'origin_date' => Language::$originDate,
			'resolution_date' => Language::$resolutionDate,
			'solver_id' => Language::$solver,
			'sent' => Language::$send,
