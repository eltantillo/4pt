...
class templates extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'name' => Language::$name,
			'work_statement' => Language::$workStatement,
			'delivery_instructions' => Language::$deliveryInstructions,
			'tasks' => Language::$tasks,
			'risks' => Language::$risks,
			'minutes' => Language::$minutes,
			'progress_report' => Language::$progressReport,
			'corrective_actions' => Language::$correctiveActions,
			'software_requirements' => Language::$softwareRequirements,
			'user_manual' => Language::$userManual,
			'software_design' => Language::$softwareDesign,
			'operation_manual' => Language::$operationManual,
			'maintenance_manual' => Language::$maintenanceManual,
			'software_components' => Language::$softwareComponents,
			'test_reports' => Language::$testReports,
			'act_of_acceptance' => Language::$actOfAcceptance,
		);
	}
