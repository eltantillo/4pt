...
/**
 * This is the model class for table "design_restrictions".
 *
 * The followings are the available columns in table 'design_restrictions':
 * @property string $id
 * @property string $software_requirements_id
 * @property string $description
 */
class design_restrictions extends CActiveRecord
{
	/**
	...
	public function search()
	{
		...
		return new CActiveDataProvider('design_restrictions', array(
			'criteria'=>$criteria,
		));
	}
	 ...
	 * @return design_restrictions the static model class
	 */
